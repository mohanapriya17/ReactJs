...
class UserPage extends Component {
    ...
    render() {
            ...
            return (
                ...
                option value = "author" > Author < /option> { /* <option value="genre">ID</option> */ } <
                /select>
                ...
                /><br/ > < br / > { /* <button onClick={this.handleSubmit}>Search</button>*/ } <
                Link to = '/userbooks'
                className = "btn btn-primary" > My Books < /Link>
                ...
                tbody > {
                    this.state.searchedBooks.map(p => p.available_copies > 0 ? < tr >
                        ...
                        onClick = {
                            () => this.handleClick(p, user) } > Check - Out < /button></td >
                        <
                        /tr> :
                        < tr >
                        <
